...
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty(value = "商品特征")
    private String productFeature;

    private String productSimilarity;
    ...
    public String getProductSimilarity() {
        return productSimilarity;
    }

    public void setProductSimilarity(String productSimilarity) {
