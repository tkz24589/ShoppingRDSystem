...
public class PmsPortalProductServiceImpl implements PmsPortalProductService {
    ...
    @Override
    public HomeContentResult searchRecommendation(String productCategoryName) {
        HomeContentResult result = new HomeContentResult();
        //获取新品推荐
        result.setNewProductList(homeDao.searchByCategoryName(0, 20, productCategoryName));
        return result;
    }
