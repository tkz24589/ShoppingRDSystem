...
export const userInfo = (params) => {
  return false
  //  return http.fetchGet('/home/member/checkLogin', params)
}
// 注册账号
...
// 推荐接口
export const imgProcess = (params) => {
  return http.fetchPost('/img', params)
}

// 推荐接口
export const img = (params) => {
  return http.fetchPost('/product/img_pro', params)
}
