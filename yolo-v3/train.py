...
global writer
global gpu_nms_op
global pred_boxes_flag
global pred_scores_flag
global saver_to_save
global val_init_op
global saver_best
global best_mAP
...
if __name__ == "__main__":
    ...
    saver_to_restore = tf.train.Saver(
        var_list=tf.contrib.framework.get_variables_to_restore(include=args.restore_include,
                                                               exclude=args.restore_exclude))
